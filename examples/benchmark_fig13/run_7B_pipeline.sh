...
do
    ...
    do
        ...
        python examples/start_rlvr_pipeline_async.py \
            ...
            --config_name rlvr_config_qwen2-7B_layerbylayer \
            ...
            > ${timestamp}_rollout${ROLLOUT_BATCH_SIZE}_pipeline_maxnew${MAX_NEW_TOKENS}.log 2>&1
        echo "save log to ${timestamp}_rollout${ROLLOUT_BATCH_SIZE}_pipeline_maxnew${MAX_NEW_TOKENS}.log"
        ray stop --force
    done
done