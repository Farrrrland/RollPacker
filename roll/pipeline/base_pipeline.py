...
class BasePipeline:
    ...
    def model_update(self, global_step, update_instance=None):
        metrics = {}
        for model_cluster_idx, model_update_group in enumerate(self.model_update_groups):
            if model_cluster_idx == update_instance or update_instance == None:
