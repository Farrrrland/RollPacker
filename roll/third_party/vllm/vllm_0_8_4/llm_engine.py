    ...
    def update_worker_cls_config(cls, vllm_config: VllmConfig) -> None:
        ...
        if scheduler_config.is_multi_step:
            ...
            if envs.VLLM_USE_V1:
                ...
                # parallel_config.worker_cls = "roll.third_party.vllm.vllm_0_8_4.spec_decode_worker.SpecDecodeWorker084"
                parallel_config.worker_cls = "roll.third_party.vllm.vllm_0_8_4.spec_decode_worker.create_spec_worker_new" # this is a function 
                pass 
        else:
            if envs.VLLM_USE_V1:
                parallel_config.worker_cls = "roll.third_party.vllm.vllm_0_8_4.v1.worker.Worker084"
