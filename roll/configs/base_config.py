...
class ScheduleConfig:
    ...
    generate_redundancy_num: int = field(
        default=0,
        metadata={"help": "The number of redundant num to be generated. drop"}
    )
    drop_generation_num: int = field(
        default=0,
        metadata={
            "help": "The redundant samples number of one prompt to be dropped. The real sampling num"
            " of one prompt would be  `drop_generation_num + num_return_sequences`"
        },
    )
